...
# was getting another unexpected indent (Line 10 & 11)
...
inc_letters = ['C', 'D', 'E', 'F', 'G']
c = [i.name for i in humans if (i.name[0] in inc_letters)]
print(c)
...
# i could just print it but directions say "join"
# must turn age into string so i can do that..
